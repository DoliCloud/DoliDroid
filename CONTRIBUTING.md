...
Issues are managed on [GitHub](https://github.com/DoliCloud/DoliDroid/issues). 
...
If you're fixing a bug, it is preferred that you cook your fix and pull request it in the develop branch.
...
Documentation
-------------
The project's documentation is maintained on the [Wiki]([https://wiki.dolibarr.org/index.php/DoliDroid](https://wiki.dolibarr.org/index.php/DoliDroid)).
